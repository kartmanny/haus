        ...
        <div className={styles.dashboard}>
            ...
            <Text type="title3"> Overall Haüs Score: <span className={styles.dashboardScore}> {dashboardTitle.overall} </span> </Text>
                ...
                <div className={styles.dashboardStats}>
                    ...
                    <Text type="small" className={styles.dashboardCategoryTitle}>Top ranked schools in this city's neighborhood</Text>
                    {SCHOOLS.map(({ name, rank }) => (
                        <Text type="regular"> <Grade type='A'>#{rank}</Grade> {name} </Text>
                    ))}
