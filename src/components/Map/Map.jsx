...
const Map = ({ onNeighborhoodPress = () => 1 }) => {
  return (
    <svg
      version="1.1"
      x="0px"
    ...
    >
      ...
      <g id="Layer_3">
        <path
          className={styles.st2}
          data-name="Magnolia"
          onNeighborhoodPress={() => onNeighborhoodPress('Magnolia')}
      ...
      c-0.3-1.1-1.6-2.7-3.8-3.3c-2.2-0.7-1.4-0.9-2.6-4.7c-1.2-3.8-2.7-4.2-2.7-4.2"
        ...
        <path
          className={styles.st2}
          data-name="Interbay"
          onNeighborhoodPress={() => onNeighborhoodPress('Interbay')}
      ...
      c-2.4-0.9-4.2-2.2-7.4-1.3c-3.2,0.8-5.3-0.3-6.3-1.8c-1-1.4-2.9-1.8-3.8-1.8S67.9,148.8,67.9,148.8z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Queen Anne')}
      ...
      S99.4,160.2,99.4,160.2z"
        ...
        <polygon
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Lower Queen Anne')}
      ...
      124.9,238.8 100.4,211.8 	"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('East Queen Anne')}
          d="M124.5,196.6l0.9,24.5l14.1,0.2l1.1-14.6c0,0-4.1-8-4.7-11.8s-0.4-7.5-0.4-7.5l-1.5-1.6l-0.1,7.1L124.5,196.6z
      "
        />
        <path
          className={cx(styles.st2)}
          data-name="Westlake"
          onNeighborhoodPress={() => onNeighborhoodPress('Westlake')}
      ...
      s-0.4-5.2-0.4-5.2L134.8,184.4z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('South Lake Union')}
      ...
      "
        ...
        <path
          className={styles.st2}
          data-name="Belltown"
          onNeighborhoodPress={() => onNeighborhoodPress('Belltown')}
          d="M125.2,240.8v3.3l9.2,8.1l4.5,1.4c0,0,0.8-3.5,2.9-2.7s3.2,2.1,3.2,2.1l13.3-8.8l0.4-3.4H125.2z"
        />
        <path
          className={styles.st2}
          data-name="Eastlake"
          onNeighborhoodPress={() => onNeighborhoodPress('Eastlake')}
      ...
      z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Portage Bay')}
      ...
      c-0.5-2-1.7-2.6-1.7-2.6s-0.9,0.5-1.2-1c-0.3-1.6-1-2.8-1-3s-1-2.7-2.6-4S168.2,173.7,168.2,173.7z"
        ...
        <path
          className={styles.st2}
          data-name="Montlake"
          onNeighborhoodPress={() => onNeighborhoodPress('Montlake')}
      ...
      S168,194.7,168,194.7z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Capitol Hill')}
      ...
      h-10.8l-0.1-6.3h-1.2l-0.1,10.3c0,0-0.4,1.4-1.2,2.7s-3.6,4.6-4.3,6.5S160.7,224.4,160.7,224.4z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Madison Valley')}
      ...
      v-15.4l1.3-1.4L194.6,209.5z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Central District')}
      ...
      s0.8-5.2,0.6-8.3s-0.5-4.8-0.1-8.2s1.8-12.1,1.4-15.6s-1.3-7.1-0.6-9.8s1.8-2.1,1.2-6.1S199.9,240.4,199.9,240.4z"
        ...
        <path
          className={styles.st2}
          data-name="Leschi"
          onNeighborhoodPress={() => onNeighborhoodPress('Leschi')}
      ...
      s0-2.4,0-2.4s-2.2,0.4-2.6-1.9s-0.6-1.5-0.6-1.5l-13.2,0.5c0,0-0.2,14.1-0.5,15.6s-1,5.5-1,8.4S199.8,293.3,199.8,293.3z"
        ...
        <path
          className={styles.st2}
          data-name="Madrona"
          onNeighborhoodPress={() => onNeighborhoodPress('Madrona')}
      ...
      s-1.6-6.4-2.6-7.6s-1.6-1.1-1.8-1.2s-9.5-0.6-9.5-0.6L201.4,259.3z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Denny Blaine')}
      ...
      s1.6,4.6,2.2,6.2s0.7,2.5,1.5,2.8S220.3,251.4,220.3,251.4z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Downtown Waterfront')}
      ...
      l-3.6-2.6L140,255.1z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('First Hill')}
      ...
      l-9.8,0.6L158.7,251.4z"
        ...
        <polygon
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Vesler Terrace')}
          points="164.7,271.6 167.9,274.6 174,274.6 173.6,268.1 170.3,268.1 	"
        />
        <polyline
          className={styles.st2}
          data-name="Pioneer Square"
          onNeighborhoodPress={() => onNeighborhoodPress('Pioneer Square')}
      ...
      s3.2,4.3,3.7,4.6c0.5,0.3,0.5,0.3,0.5,0.3l-6.3-13l-3.4-4.5l-8,0.7l-3.9-3.3H159.7z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Industrial District')}
      ...
      c-0.2-3.7-0.4-9.8-0.4-12.6c0-2.8-0.7-1.7,0.3-3.8c1-2.2,0.4-2.7-0.1-4.3S141.1,291,141.1,291z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Harbor Island')}
      ...
      s-3.6-2.2-4.5-3.6s-3-3.6-5-3.7S118.6,325.2,118.6,325.2z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('North Admiral')}
      ...
      s-2.3-3.1-3.4-5s0.1-0.6-2.1-3.1s-2.8-3.6-2.8-3.6"
        ...
        <path
          className={styles.st2}
          data-name="Alki"
          onNeighborhoodPress={() => onNeighborhoodPress('Alki')}
      ...
      c4.8-1.2,6.2,0,6.2,0L90.7,285z"
        ...
        <path
          className={styles.st2}
          data-name="Genesee"
          onNeighborhoodPress={() => onNeighborhoodPress('Genesee')}
      ...
      c-1.2,0.3-1.7,0.4-2.2-0.6S71.6,333.8,71.6,333.8z"
        ...
        <path
          className={styles.st2}
          data-name="Seaview"
          onNeighborhoodPress={() => onNeighborhoodPress('Seaview')}
      ...
      l-0.6,3.4h-1.9c0,0-1.1-2-2.2-3.4c-1.1-1.4-1.9-3.9-3.4-2.9C63.9,353,63.9,353,63.9,353z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Fairmount Park')}
          d="M86.5,380.8c0,0,1.7-0.5,2.9-1.8s9.1-1,9.1-1v-13.5l1.1-1.2V345l-5.3,4.8l-0.8,5.1H87L86.5,380.8z"
        />
        <path
          className={styles.st2}
          data-name="Gatewood"
          onNeighborhoodPress={() => onNeighborhoodPress('Gatewood')}
      ...
      s-1.8,0.5-1.8,0.5l-0.2,2.3l-4.2-0.1l-3,5.5C71.1,391.1,71.1,391.1,71.1,391.1z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Fauntleroy')}
          className={styles.st2}
      ...
      L83,395.7h-1.7L81.5,396.4z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Arbor Heights')}
      ...
      c-1-0.2,1.1-0.8,1.1-0.8l-0.5-12c0,0-5.9,0.8-6.8-0.2c-0.9-1-1.3-5.5-1.8-6.8c-0.4-1.2-4.2-1.9-4.2-7S81,435.7,81,435.7z"
        ...
        <path
          className={styles.st2}
          data-name="Delridge"
          onNeighborhoodPress={() => onNeighborhoodPress('Delridge')}
      ...
      s-2.1-5.1-2.4-6.2s-1.4-1.1-2.5-1.8s-14.6-1.2-14.6-1.2s-1.6,10.4-2.6,12.9s-4.1,1.2-4.1,1.2L101.7,364.6z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('South Park')}
      ...
      c0,0-0.3-0.2-0.4,2.5c-0.1,2.6,0.1,0,0,5.9c-0.1,5.9,1,19.4,1.8,24.5c0.8,5.1,1.7,5.1,1.7,5.1l3.9,0.6L162.8,427.8z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Georgetown')}
      ...
      c0,0-4.8-7.7-4.9-10.3c-0.1-2.7-1.5-5.2-1.9-6.6C146.2,368.4,142,359.8,142,359.8z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Beacon Hill')}
      ...
      C206.2,417.8,207,427.6,207,427.6z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Rainier Beach')}
      ...
      s-7.1,3.3-9.2,2.4s-2.1-0.9-2.1-0.9l-0.9,1.4l-8.7,0.1c0,0,0.4,0.8-1.2-0.4S221.5,429.8,221.5,429.8z"
        ...
        <path
          className={styles.st2}
          data-name="Dunlap"
          onNeighborhoodPress={() => onNeighborhoodPress('Dunlap')}
      ...
      s-1.6-1.1-2.3-0.6S222.4,333.6,222.4,333.6z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Columbia City')}
      ...
      s14.5,0,14.5,0v12.8l1.2,0.8v4.6h-19.4l-4.6-13.8l-6.2-2.3l-0.8-0.2V322.4z"
        ...
        <polygon
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Hillman City')}
          points="209.9,365.7 214.4,378.6 228.8,378.6 229.1,366.1 	"
        />
        <path
          className={styles.st2}
          data-name="Mount Baker"
          onNeighborhoodPress={() => onNeighborhoodPress('Mount Baker')}
      ...
      s-0.1-1.1-0.1-1.6s1.5-3.2,2-4.4s0-6.3,0-6.3l-14.5,0.3L199.4,308.7z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Madison Park')}
      ...
      C217.5,232.5,219.2,231.3,219.2,231.3z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Laurelhurst')}
      ...
      c-0.8,1.2-3.2,2.5-3.2,5.2C226.8,177.5,226.8,177.5,226.8,177.5z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Windermere')}
      ...
      l-0.2-4.8c0,0-18-0.1-18.5,0.6s-1.8,1.2-1.8,1.2s-0.2,1.1-1.3-0.2c-1.1-1.3-1.1-1.3-1.1-1.3L222.1,129.9z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('University District')}
          className={cx(styles.st2)}
      ...
      l8.6,3.8l0.3,4.5l4-0.4v13.8L207.2,158.4z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Wallingford')}
      ...
      s-0.6,0.9-1.2,2.1c-0.7,1.2-0.9,1.2-1.5,1.2s-0.6,0-0.6,0s-1.6,0.6-2.2,1.2c-0.7,0.6-0.8,1.8-0.8,1.8v7.5l-0.2,1.1L137,151.3z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Phinney Ridge')}
      ...
      c0.3-2.5,1.8-12.8,1.8-12.8h-24.5v12.2l6.4,0.1v19.1c0,0,2.8,7.2,4.6,7.8c1.8,0.6,2.2,0.8,2.2,0.8v-6.2L144.2,148.8z"
        ...
        <path
          className={styles.st2}
          data-name="Fremont"
          onNeighborhoodPress={() => onNeighborhoodPress('Fremont')}
      ...
      s0.6-21.9,0.6-21.9l-6.3,0.1v-6.8L128.3,151.3z"
        ...
        <path
          className={styles.st2}
          data-name="Ballard"
          onNeighborhoodPress={() => onNeighborhoodPress('Ballard')}
      ...
      s1,2.7,2.9,3.8c1.9,1.1,0.7,1.6,3.4,2.3s3.8,1,6.2,1.9s7.5,3.4,8,3.9c0.5,0.5,2.6,2.3,3,3.2c0.4,0.9,0.5,1.1,0.5,1.1L111.6,156.3z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('North Beach')}
      ...
      "
        ...
        <polygon
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Crown Hill')}
          points="92.8,94.1 92.8,100 111.2,100 111.2,73.6 102,73.6 102,80.6 99.4,80.5 99.4,93.9 	"
        />
        <polygon
          className={styles.st2}
          data-name="Greenwood"
          onNeighborhoodPress={() => onNeighborhoodPress('Greenwood')}
          points="113.6,113.9 139,113.9 138,73.6 113.6,73.6 	"
        />
        <path
          className={styles.st2}
          data-name="Broadview"
          onNeighborhoodPress={() => onNeighborhoodPress('Broadview')}
      ...
      s-18.5,2.2-18-1.4c0.6-3.6-2-3.6,0.8-5.8s6.4-5.6,6.4-5.6s-0.5-2.8-0.5-6.1s-0.6-2.9,0-6.2S102,20.4,102,20.4z"
        ...
        <rect
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Bitter Lake')}
          x="126.3"
          y="20.4"
          className={styles.st2}
          width="12.7"
        ...
        <path
          data-name="Northgate"
          onNeighborhoodPress={() => onNeighborhoodPress('Northgate')}
          className={styles.st2}
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Olympic Hills')}
          d="M180.6,20.4l0.9,24h20c0,0,4.4-13.6,4-17s0-6.1,0-6.1L180.6,20.4z"
        />
        <path
          className={styles.st2}
          data-name="Cedar Park"
          onNeighborhoodPress={() => onNeighborhoodPress('Cedar Park')}
      ...
      l-15,0.8c0,0,5.8-14.5,6.4-19.1S207.6,21,207.6,21z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Victory Heights')}
      ...
      l-19-0.5V80.9z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Meadowbrook')}
      ...
      c2-3.3,2.5-3.2,2.2-4.7s-0.8-2.8-0.5-5.2s1.6-9.3,2.9-11.6C199,57.2,200,52.8,200,52.8z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Matthews Beach')}
      ...
      S207,53.8,207,53.8z"
        ...
        <path
          className={styles.st2}
          data-name="Wedgwood"
          onNeighborhoodPress={() => onNeighborhoodPress('Wedgwood')}
      ...
      L189.6,88.6z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('Sand Point')}
      ...
      c0,0,3.4-9.9,5.6-12.6s2.9-1.3,2.1-4.5s1.1-2.3-2.9-6.1s-5.6-5.8-9.6-6.1s-10.4-3.1-11.4-3.1s-2.5,0-2.5,0V103.5z"
        ...
        <path
          ...
          onNeighborhoodPress={() => onNeighborhoodPress('View Ridge')}
      ...
      c-0.7-2.9-1.2-7.9-2.4-9.6s-1.2-1.4-2.6-3.1s-2.3-2.9-4.1-2.3s-4.2,1.6-5.6,1.9S222.1,98.8,222.1,98.8z"
        ...
        <polyline
          className={styles.st2}
          data-name="Bryant"
          onNeighborhoodPress={() => onNeighborhoodPress('Bryant')}
      ...
      208.2,156.3 	"
        ...
        <path
          className={styles.st2}
          data-name="Ravenna"
          onNeighborhoodPress={() => onNeighborhoodPress('Ravenna')}
      ...
      s0.2-2.7,0.2-2.7h-5.2l0.2,14.6L181.9,116.3z"
        ...
        <path
          className={styles.st2}
          data-name="Roosevelt"
          onNeighborhoodPress={() => onNeighborhoodPress('Roosevelt')}
      ...
      c0.3,2.8-0.4,7.7-0.4,7.7s2.9,1.8,3,2.5c0.1,0.7,5.5,3.1,5.5,3.1l1.6-1.3l-0.3-16.3l0.2-4.2l-0.2-1.3H186.2z"
        ...
        <path
          className={styles.st2}
          data-name="Greenlake"
          onNeighborhoodPress={() => onNeighborhoodPress('Greenlake')}
