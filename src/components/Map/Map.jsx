...
const Map = ({ current = '', onNeighborhoodPress = () => 1 }) => {
  ...
  return (
    ...
    >
      ...
      <g id="Layer_3">
        <path
          className={cx(styles.st2, current === 'Magnolia' && styles.active)}
          data-name="Magnolia"
          onClick={() => onNeighborhoodPress('Magnolia')}
      ...
      c-0.3-1.1-1.6-2.7-3.8-3.3c-2.2-0.7-1.4-0.9-2.6-4.7c-1.2-3.8-2.7-4.2-2.7-4.2"
        />
        <path
          className={cx(styles.st2, current === 'Interbay' && styles.active)}
          data-name="Interbay"
          onClick={() => onNeighborhoodPress('Interbay')}
      ...
      c-2.4-0.9-4.2-2.2-7.4-1.3c-3.2,0.8-5.3-0.3-6.3-1.8c-1-1.4-2.9-1.8-3.8-1.8S67.9,148.8,67.9,148.8z"
        />
        <path
          className={cx(styles.st2, current === 'Queen Anne' && styles.active)}
          data-name="Queen Anne"
          onClick={() => onNeighborhoodPress('Queen Anne')}
      ...
      S99.4,160.2,99.4,160.2z"
        ...
        <polygon
          className={cx(
            styles.st2,
            current === 'Lower Queen Anne' && styles.active
          )}
          data-name="Lower Queen Anne"
          onClick={() => onNeighborhoodPress('Lower Queen Anne')}
      ...
      124.9,238.8 100.4,211.8 	"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'East Queen Anne' && styles.active
          )}
          data-name="East Queen Anne"
          onClick={() => onNeighborhoodPress('East Queen Anne')}
          d="M124.5,196.6l0.9,24.5l14.1,0.2l1.1-14.6c0,0-4.1-8-4.7-11.8s-0.4-7.5-0.4-7.5l-1.5-1.6l-0.1,7.1L124.5,196.6z
      "
        />
        <path
          className={cx(styles.st2, current === 'Westlake' && styles.active)}
          data-name="Westlake"
          onClick={() => onNeighborhoodPress('Westlake')}
      ...
      s-0.4-5.2-0.4-5.2L134.8,184.4z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'South Lake Union' && styles.active
          )}
          data-name="South Lake Union"
          onClick={() => onNeighborhoodPress('South Lake Union')}
      ...
      "
        />
        <path
          className={cx(styles.st2, current === 'Belltown' && styles.active)}
          data-name="Belltown"
          onClick={() => onNeighborhoodPress('Belltown')}
          d="M125.2,240.8v3.3l9.2,8.1l4.5,1.4c0,0,0.8-3.5,2.9-2.7s3.2,2.1,3.2,2.1l13.3-8.8l0.4-3.4H125.2z"
        />
        <path
          className={cx(styles.st2, current === 'Eastlake' && styles.active)}
          data-name="Eastlake"
          onClick={() => onNeighborhoodPress('Eastlake')}
      ...
      z"
        />
        <path
          className={cx(styles.st2, current === 'Portage Bay' && styles.active)}
          data-name="Portage Bay"
          onClick={() => onNeighborhoodPress('Portage Bay')}
      ...
      c-0.5-2-1.7-2.6-1.7-2.6s-0.9,0.5-1.2-1c-0.3-1.6-1-2.8-1-3s-1-2.7-2.6-4S168.2,173.7,168.2,173.7z"
        />
        <path
          className={cx(styles.st2, current === 'Montlake' && styles.active)}
          data-name="Montlake"
          onClick={() => onNeighborhoodPress('Montlake')}
      ...
      S168,194.7,168,194.7z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Capitol Hill' && styles.active
          )}
          data-name="Capitol Hill"
          onClick={() => onNeighborhoodPress('Capitol Hill')}
      ...
      h-10.8l-0.1-6.3h-1.2l-0.1,10.3c0,0-0.4,1.4-1.2,2.7s-3.6,4.6-4.3,6.5S160.7,224.4,160.7,224.4z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Madison Valley' && styles.active
          )}
          data-name="Madison Valley"
          onClick={() => onNeighborhoodPress('Madison Valley')}
      ...
      v-15.4l1.3-1.4L194.6,209.5z"
        ...
        <path
          className={cx(
            cx(styles.st2),
            current === 'Central District' && styles.active
          )}
          data-name="Central District"
          onClick={() => onNeighborhoodPress('Central District')}
      ...
      s0.8-5.2,0.6-8.3s-0.5-4.8-0.1-8.2s1.8-12.1,1.4-15.6s-1.3-7.1-0.6-9.8s1.8-2.1,1.2-6.1S199.9,240.4,199.9,240.4z"
        />
        <path
          className={cx(styles.st2, current === 'Leschi' && styles.active)}
          data-name="Leschi"
          onClick={() => onNeighborhoodPress('Leschi')}
      ...
      s0-2.4,0-2.4s-2.2,0.4-2.6-1.9s-0.6-1.5-0.6-1.5l-13.2,0.5c0,0-0.2,14.1-0.5,15.6s-1,5.5-1,8.4S199.8,293.3,199.8,293.3z"
        />
        <path
          className={cx(styles.st2, current === 'Madrona' && styles.active)}
          data-name="Madrona"
          onClick={() => onNeighborhoodPress('Madrona')}
      ...
      s-1.6-6.4-2.6-7.6s-1.6-1.1-1.8-1.2s-9.5-0.6-9.5-0.6L201.4,259.3z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Denny Blaine' && styles.active
          )}
          data-name="Denny Blaine"
          onClick={() => onNeighborhoodPress('Denny Blaine')}
      ...
      s1.6,4.6,2.2,6.2s0.7,2.5,1.5,2.8S220.3,251.4,220.3,251.4z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Downtown Waterfront' && styles.active
          )}
          data-name="Downtown Waterfront"
          onClick={() => onNeighborhoodPress('Downtown Waterfront')}
      ...
      c0,0-3.4-0.7-5.2-2.4S123.9,245.6,123.9,245.6z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Central Business District' && styles.active
          )}
          data-name="Central Business District"
          onClick={() => onNeighborhoodPress('Central Business District')}
      ...
      l-3.6-2.6L140,255.1z"
        />
        <path
          className={cx(styles.st2, current === 'First Hill' && styles.active)}
          data-name="First Hill"
          onClick={() => onNeighborhoodPress('First Hill')}
      ...
      l-9.8,0.6L158.7,251.4z"
        ...
        <polygon
          className={cx(
            styles.st2,
            current === 'Vesler Terrace' && styles.active
          )}
          data-name="Vesler Terrace"
          onClick={() => onNeighborhoodPress('Vesler Terrace')}
          points="164.7,271.6 167.9,274.6 174,274.6 173.6,268.1 170.3,268.1 	"
        />
        <polyline
          className={cx(
            styles.st2,
            current === 'Pioneer Square' && styles.active
          )}
          data-name="Pioneer Square"
          onClick={() => onNeighborhoodPress('Pioneer Square')}
          points="149.7,270.9 153.2,271.3 158.1,278.2 158.1,289.3 151.6,289.3 151.2,274 149.7,270.2 	"
        />
        <path
          className={cx(
            styles.st2,
            current === 'International District' && styles.active
          )}
          data-name="International District"
          onClick={() => onNeighborhoodPress('International District')}
      ...
      s3.2,4.3,3.7,4.6c0.5,0.3,0.5,0.3,0.5,0.3l-6.3-13l-3.4-4.5l-8,0.7l-3.9-3.3H159.7z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Industrial District' && styles.active
          )}
          data-name="Industrial District"
          onClick={() => onNeighborhoodPress('Industrial District')}
      ...
      c-0.2-3.7-0.4-9.8-0.4-12.6c0-2.8-0.7-1.7,0.3-3.8c1-2.2,0.4-2.7-0.1-4.3S141.1,291,141.1,291z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Harbor Island' && styles.active
          )}
          data-name="Harbor Island"
          onClick={() => onNeighborhoodPress('Harbor Island')}
      ...
      s-3.6-2.2-4.5-3.6s-3-3.6-5-3.7S118.6,325.2,118.6,325.2z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'North Admiral' && styles.active
          )}
          data-name="North Admiral"
          onClick={() => onNeighborhoodPress('North Admiral')}
      ...
      s-2.3-3.1-3.4-5s0.1-0.6-2.1-3.1s-2.8-3.6-2.8-3.6"
        />
        <path
          className={cx(styles.st2, current === 'Alki' && styles.active)}
          data-name="Alki"
          onClick={() => onNeighborhoodPress('Alki')}
      ...
      c4.8-1.2,6.2,0,6.2,0L90.7,285z"
        />
        <path
          className={cx(styles.st2, current === 'Genesee' && styles.active)}
          data-name="Genesee"
          onClick={() => onNeighborhoodPress('Genesee')}
      ...
      c-1.2,0.3-1.7,0.4-2.2-0.6S71.6,333.8,71.6,333.8z"
        />
        <path
          className={cx(styles.st2, current === 'Seaview' && styles.active)}
          data-name="Seaview"
          onClick={() => onNeighborhoodPress('Seaview')}
      ...
      l-0.6,3.4h-1.9c0,0-1.1-2-2.2-3.4c-1.1-1.4-1.9-3.9-3.4-2.9C63.9,353,63.9,353,63.9,353z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Fairmount Park' && styles.active
          )}
          data-name="Fairmount Park"
          onClick={() => onNeighborhoodPress('Fairmount Park')}
          d="M86.5,380.8c0,0,1.7-0.5,2.9-1.8s9.1-1,9.1-1v-13.5l1.1-1.2V345l-5.3,4.8l-0.8,5.1H87L86.5,380.8z"
        />
        <path
          className={cx(styles.st2, current === 'Gatewood' && styles.active)}
          data-name="Gatewood"
          onClick={() => onNeighborhoodPress('Gatewood')}
      ...
      s-1.8,0.5-1.8,0.5l-0.2,2.3l-4.2-0.1l-3,5.5C71.1,391.1,71.1,391.1,71.1,391.1z"
        />
        <path
          className={cx(styles.st2, current === 'Fauntleroy' && styles.active)}
          data-name="Fauntleroy"
          onClick={() => onNeighborhoodPress('Fauntleroy')}
      ...
      L83,395.7h-1.7L81.5,396.4z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Arbor Heights' && styles.active
          )}
          data-name="Arbor Heights"
          onClick={() => onNeighborhoodPress('Arbor Heights')}
      ...
      c-1-0.2,1.1-0.8,1.1-0.8l-0.5-12c0,0-5.9,0.8-6.8-0.2c-0.9-1-1.3-5.5-1.8-6.8c-0.4-1.2-4.2-1.9-4.2-7S81,435.7,81,435.7z"
        />
        <path
          className={cx(styles.st2, current === 'Delridge' && styles.active)}
          data-name="Delridge"
          onClick={() => onNeighborhoodPress('Delridge')}
      ...
      s-2.1-5.1-2.4-6.2s-1.4-1.1-2.5-1.8s-14.6-1.2-14.6-1.2s-1.6,10.4-2.6,12.9s-4.1,1.2-4.1,1.2L101.7,364.6z"
        />
        <path
          className={cx(styles.st2, current === 'South Park' && styles.active)}
          data-name="South Park"
          onClick={() => onNeighborhoodPress('South Park')}
      ...
      c0,0-0.3-0.2-0.4,2.5c-0.1,2.6,0.1,0,0,5.9c-0.1,5.9,1,19.4,1.8,24.5c0.8,5.1,1.7,5.1,1.7,5.1l3.9,0.6L162.8,427.8z"
        />
        <path
          className={cx(styles.st2, current === 'Georgetown' && styles.active)}
          data-name="Georgetown"
          onClick={() => onNeighborhoodPress('Georgetown')}
      ...
      c0,0-4.8-7.7-4.9-10.3c-0.1-2.7-1.5-5.2-1.9-6.6C146.2,368.4,142,359.8,142,359.8z"
        />
        <path
          className={cx(styles.st2, current === 'Beacon Hill' && styles.active)}
          data-name="Beacon Hill"
          onClick={() => onNeighborhoodPress('Beacon Hill')}
      ...
      C206.2,417.8,207,427.6,207,427.6z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Rainier Beach' && styles.active
          )}
          data-name="Rainier Beach"
          onClick={() => onNeighborhoodPress('Rainier Beach')}
      ...
      s-7.1,3.3-9.2,2.4s-2.1-0.9-2.1-0.9l-0.9,1.4l-8.7,0.1c0,0,0.4,0.8-1.2-0.4S221.5,429.8,221.5,429.8z"
        />
        <path
          className={cx(styles.st2, current === 'Dunlap' && styles.active)}
          data-name="Dunlap"
          onClick={() => onNeighborhoodPress('Dunlap')}
      ...
      L220.6,408.4z"
        />
        <polygon
          className={cx(styles.st2, current === 'Brighton' && styles.active)}
          data-name="Brighton"
          onClick={() => onNeighborhoodPress('Brighton')}
          points="214.8,380.1 232.9,380.1 233.2,392.8 236.2,392.8 237.1,406.3 220.6,406 221.5,398.9 	"
        />
        <path
          className={cx(styles.st2, current === 'Seward Park' && styles.active)}
          data-name="Seward Park"
          onClick={() => onNeighborhoodPress('Seward Park')}
      ...
      s-1.6-1.1-2.3-0.6S222.4,333.6,222.4,333.6z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Columbia City' && styles.active
          )}
          data-name="Columbia City"
          onClick={() => onNeighborhoodPress('Columbia City')}
      ...
      s14.5,0,14.5,0v12.8l1.2,0.8v4.6h-19.4l-4.6-13.8l-6.2-2.3l-0.8-0.2V322.4z"
        ...
        <polygon
          className={cx(
            styles.st2,
            current === 'Hillman City' && styles.active
          )}
          data-name="Hillman City"
          onClick={() => onNeighborhoodPress('Hillman City')}
          points="209.9,365.7 214.4,378.6 228.8,378.6 229.1,366.1 	"
        />
        <path
          className={cx(styles.st2, current === 'Mount Baker' && styles.active)}
          data-name="Mount Baker"
          onClick={() => onNeighborhoodPress('Mount Baker')}
      ...
      s-0.1-1.1-0.1-1.6s1.5-3.2,2-4.4s0-6.3,0-6.3l-14.5,0.3L199.4,308.7z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Madison Park' && styles.active
          )}
          data-name="Madison Park"
          onClick={() => onNeighborhoodPress('Madison Park')}
      ...
      C217.5,232.5,219.2,231.3,219.2,231.3z"
        />
        <path
          className={cx(styles.st2, current === 'Laurelhurst' && styles.active)}
          data-name="Laurelhurst"
          onClick={() => onNeighborhoodPress('Laurelhurst')}
      ...
      c-0.8,1.2-3.2,2.5-3.2,5.2C226.8,177.5,226.8,177.5,226.8,177.5z"
        />
        <path
          className={cx(styles.st2, current === 'Windermere' && styles.active)}
          data-name="Windermere"
          onClick={() => onNeighborhoodPress('Windermere')}
      ...
      l-0.2-4.8c0,0-18-0.1-18.5,0.6s-1.8,1.2-1.8,1.2s-0.2,1.1-1.3-0.2c-1.1-1.3-1.1-1.3-1.1-1.3L222.1,129.9z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'University District' && styles.active
          )}
          data-name="University District"
          onClick={() => onNeighborhoodPress('University District')}
      ...
      l8.6,3.8l0.3,4.5l4-0.4v13.8L207.2,158.4z"
        />
        <path
          className={cx(styles.st2, current === 'Wallingford' && styles.active)}
          data-name="Wallingford"
          onClick={() => onNeighborhoodPress('Wallingford')}
      ...
      s-0.6,0.9-1.2,2.1c-0.7,1.2-0.9,1.2-1.5,1.2s-0.6,0-0.6,0s-1.6,0.6-2.2,1.2c-0.7,0.6-0.8,1.8-0.8,1.8v7.5l-0.2,1.1L137,151.3z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Phinney Ridge' && styles.active
          )}
          data-name="Phinney Ridge"
          onClick={() => onNeighborhoodPress('Phinney Ridge')}
      ...
      c0.3-2.5,1.8-12.8,1.8-12.8h-24.5v12.2l6.4,0.1v19.1c0,0,2.8,7.2,4.6,7.8c1.8,0.6,2.2,0.8,2.2,0.8v-6.2L144.2,148.8z"
        />
        <path
          className={cx(styles.st2, current === 'Fremont' && styles.active)}
          data-name="Fremont"
          onClick={() => onNeighborhoodPress('Fremont')}
      ...
      s0.6-21.9,0.6-21.9l-6.3,0.1v-6.8L128.3,151.3z"
        />
        <path
          className={cx(styles.st2, current === 'Ballard' && styles.active)}
          data-name="Ballard"
          onClick={() => onNeighborhoodPress('Ballard')}
      ...
      s1,2.7,2.9,3.8c1.9,1.1,0.7,1.6,3.4,2.3s3.8,1,6.2,1.9s7.5,3.4,8,3.9c0.5,0.5,2.6,2.3,3,3.2c0.4,0.9,0.5,1.1,0.5,1.1L111.6,156.3z"
        />
        <path
          className={cx(styles.st2, current === 'North Beach' && styles.active)}
          data-name="North Beach"
          onClick={() => onNeighborhoodPress('North Beach')}
      ...
      "
        />
        <polygon
          className={cx(styles.st2, current === 'Crown Hill' && styles.active)}
          data-name="Crown Hill"
          onClick={() => onNeighborhoodPress('Crown Hill')}
          points="92.8,94.1 92.8,100 111.2,100 111.2,73.6 102,73.6 102,80.6 99.4,80.5 99.4,93.9 	"
        />
        <polygon
          className={cx(styles.st2, current === 'Greenwood' && styles.active)}
          data-name="Greenwood"
          onClick={() => onNeighborhoodPress('Greenwood')}
          points="113.6,113.9 139,113.9 138,73.6 113.6,73.6 	"
        />
        <path
          className={cx(styles.st2, current === 'Broadview' && styles.active)}
          data-name="Broadview"
          onClick={() => onNeighborhoodPress('Broadview')}
      ...
      s-18.5,2.2-18-1.4c0.6-3.6-2-3.6,0.8-5.8s6.4-5.6,6.4-5.6s-0.5-2.8-0.5-6.1s-0.6-2.9,0-6.2S102,20.4,102,20.4z"
        />
        <rect
          className={cx(styles.st2, current === 'Bitter Lake' && styles.active)}
          data-name="Bitter Lake"
          onClick={() => onNeighborhoodPress('Bitter Lake')}
          x="126.3"
          y="20.4"
          width="12.7"
          height="51.5"
        />
        <path
          className={cx(styles.st2, current === 'Northgate' && styles.active)}
          data-name="Northgate"
          onClick={() => onNeighborhoodPress('Northgate')}
          d="M140.4,20.4h38.8l1.1,62.1h10.1c0,0-2.2,1.8-2.8,5.5s1,9.6-0.2,10.6s-3.5,1.4-3.5,1.4h-42.8L140.4,20.4z"
        />
        <path
          className={cx(
            styles.st2,
            current === 'Olympic Hills' && styles.active
          )}
          data-name="Olympic Hills"
          onClick={() => onNeighborhoodPress('Olympic Hills')}
          d="M180.6,20.4l0.9,24h20c0,0,4.4-13.6,4-17s0-6.1,0-6.1L180.6,20.4z"
        />
        <path
          className={cx(styles.st2, current === 'Cedar Park' && styles.active)}
          data-name="Cedar Park"
          onClick={() => onNeighborhoodPress('Cedar Park')}
      ...
      l-15,0.8c0,0,5.8-14.5,6.4-19.1S207.6,21,207.6,21z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Victory Heights' && styles.active
          )}
          data-name="Victory Heights"
          onClick={() => onNeighborhoodPress('Victory Heights')}
          d="M181.8,80.9h9.8c0,0,0.6,1.1,0.9-6.2c0.3-7.2,0-5.7,1-8.6c1-2.9,2.1-6.5,3.5-10.4c1.4-3.9,3.8-9.6,3.8-9.6
      l-19-0.5V80.9z"
        />
        <path
          className={cx(styles.st2, current === 'Meadowbrook' && styles.active)}
          data-name="Meadowbrook"
          onClick={() => onNeighborhoodPress('Meadowbrook')}
      ...
      c2-3.3,2.5-3.2,2.2-4.7s-0.8-2.8-0.5-5.2s1.6-9.3,2.9-11.6C199,57.2,200,52.8,200,52.8z"
        ...
        <path
          className={cx(
            styles.st2,
            current === 'Matthews Beach' && styles.active
          )}
          data-name="Matthews Beach"
          onClick={() => onNeighborhoodPress('Matthews Beach')}
      ...
      S207,53.8,207,53.8z"
        />
        <path
          className={cx(styles.st2, current === 'Wedgwood' && styles.active)}
          data-name="Wedgwood"
          onClick={() => onNeighborhoodPress('Wedgwood')}
          d="M189.6,88.6c0,0,0.9,7,0,8.8c-0.9,1.7-1.4,3.4-1.6,3.4s6.6,0,6.6,0s1.1,12.2,1.6,13.1s24.2,0,24.2,0V88.2
      L189.6,88.6z"
        />
        <path
          className={cx(styles.st2, current === 'Sand Point' && styles.active)}
          data-name="Sand Point"
          onClick={() => onNeighborhoodPress('Sand Point')}
      ...
      c0,0,3.4-9.9,5.6-12.6s2.9-1.3,2.1-4.5s1.1-2.3-2.9-6.1s-5.6-5.8-9.6-6.1s-10.4-3.1-11.4-3.1s-2.5,0-2.5,0V103.5z"
        />
        <path
          className={cx(styles.st2, current === 'View Ridge' && styles.active)}
          data-name="View Ridge"
          onClick={() => onNeighborhoodPress('View Ridge')}
      ...
      c-0.7-2.9-1.2-7.9-2.4-9.6s-1.2-1.4-2.6-3.1s-2.3-2.9-4.1-2.3s-4.2,1.6-5.6,1.9S222.1,98.8,222.1,98.8z"
        />
        <polyline
          className={cx(styles.st2, current === 'Bryant' && styles.active)}
          data-name="Bryant"
          onClick={() => onNeighborhoodPress('Bryant')}
          points="207.3,156.3 209.2,154.6 208.9,116.3 214.2,116.3 214.2,130 220.6,130 220.6,144.1 212.5,155.6 
      208.2,156.3 	"
        />
        <path
          className={cx(styles.st2, current === 'Ravenna' && styles.active)}
          data-name="Ravenna"
          onClick={() => onNeighborhoodPress('Ravenna')}
      ...
      s0.2-2.7,0.2-2.7h-5.2l0.2,14.6L181.9,116.3z"
        />
        <path
          className={cx(styles.st2, current === 'Roosevelt' && styles.active)}
          data-name="Roosevelt"
          onClick={() => onNeighborhoodPress('Roosevelt')}
      ...
      c0.3,2.8-0.4,7.7-0.4,7.7s2.9,1.8,3,2.5c0.1,0.7,5.5,3.1,5.5,3.1l1.6-1.3l-0.3-16.3l0.2-4.2l-0.2-1.3H186.2z"
        />
        <path
          className={cx(styles.st2, current === 'Greenlake' && styles.active)}
          data-name="Greenlake"
          onClick={() => onNeighborhoodPress('Greenlake')}
